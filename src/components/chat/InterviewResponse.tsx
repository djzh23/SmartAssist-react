...
const STYLES: Record<SectionKind, { wrap: string; h2: string; h3: string; dot: string; nb: string; nt: string; q: string }> = {
  ...
  job: {
    wrap: 'rounded-xl border border-cyan-200 bg-cyan-50 px-4 py-3',
    h2: 'text-sm font-bold text-cyan-800',
    h3: 'text-sm font-semibold text-cyan-700',
    dot: 'bg-cyan-400',
    nb: 'bg-cyan-100',
    nt: 'text-cyan-700',
    q: 'border-l-4 border-cyan-300 bg-cyan-50/60 pl-3 italic text-cyan-900',
  },
  default: {
    wrap: '',
