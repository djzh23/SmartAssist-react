...
export default function ChatInput({ toolType, isLoading, noActiveSession = false, onSend }: Props) {
  ...
  return (
    <div className="sticky bottom-[58px] z-20 flex-shrink-0 border-t border-stone-700/40 bg-app-muted/94 px-2.5 pb-[max(0.45rem,env(safe-area-inset-bottom))] pt-1.5 backdrop-blur-sm min-[391px]:px-3 min-[391px]:pb-[max(0.5rem,env(safe-area-inset-bottom))] min-[391px]:pt-2 min-[769px]:bottom-0 min-[769px]:px-4 min-[769px]:py-3">
